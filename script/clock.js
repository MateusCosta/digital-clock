...
function formatDigitalClock(time){
    return `<span class="pink">${time.hours.toString().padStart(2, '0')}</span><span class="blue">:</span><span class="orange">${time.minutes.toString().padStart(2, '0')}</span><span class="green">:</span><span class="yellow">${time.seconds.toString().padStart(2, '0')}</span>`
}
